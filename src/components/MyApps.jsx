                ...
                <li className="app-item">
                    <div className="nes-container is-rounded side-app with-title">
                        ...
                        <p className="app-info">
                            ...
                            <span>
                                <a href="https://www.youtube.com/playlist?list=PLiikGnw05G2FjOXuxFUESR3bVamKbJoaa" target="_blank">Demo Video <i className="fas fa-external-link-alt"></i></a> <a href="https://github.com/glv1at118/botanica-server" target="_blank">Source <i className="fas fa-external-link-alt"></i></a>
                            </span>
                        </p>
                    </div>
                </li>
                <li className="app-item">
                    <div className="nes-container is-rounded side-app with-title">
                        ...
                        <p className="app-info">
                            ...
                            <span>
                                <a href="https://github.com/glv1at118/blog-project" target="_blank">Source <i className="fas fa-external-link-alt"></i></a>
                            </span>
                        </p>
                    </div>
                </li>
                <li className="app-item">
                    <div className="nes-container is-rounded side-app with-title">
                        ...
                        <p className="app-info">
                            ...
                            <span>
                                <a href="https://glv1at118.github.io/Proj-Avoid-the-Bricks/Avoid%20the%20Bricks.html" target="_blank">Play Here <i className="fas fa-external-link-alt"></i></a> <a href="https://github.com/glv1at118/Proj-Avoid-the-Bricks" target="_blank">Source <i className="fas fa-external-link-alt"></i></a>
                            </span>
                        </p>
                    </div>
                </li>
                <li className="app-item">
                    <div className="nes-container is-rounded side-app with-title">
                        ...
                        <p className="app-info">
                            ...
                            <span>
                                <a href="https://glv1at118.github.io/student-profile-board/" target="_blank">Demo <i className="fas fa-external-link-alt"></i></a> <a href="https://github.com/glv1at118/student-profile-board" target="_blank">Source <i className="fas fa-external-link-alt"></i></a>
                            </span>
                        </p>
                    </div>
                </li>
                <li className="app-item">
                    <div className="nes-container is-rounded side-app with-title">
                        ...
                        <p className="app-info">
                            ...
                            - Technologies: Javascript (ES5, ES6), HTML5, CSS3, React, Redux, React-Redux, Redux DevTools<br /><br />
                            <span>
                                <a href="https://glv1at118.github.io/work-orders-board/" target="_blank">Demo <i className="fas fa-external-link-alt"></i></a> <a href="https://github.com/glv1at118/work-orders-board" target="_blank">Source <i className="fas fa-external-link-alt"></i></a>
                            </span>
                        </p>
                    </div>
                </li>
